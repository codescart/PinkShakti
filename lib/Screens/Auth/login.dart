...
import 'package:pinkPower/Screens/Auth/components/cancel_button.dart';
import 'package:pinkPower/Screens/Auth/components/login_form.dart';
import 'package:pinkPower/Screens/Auth/components/register_form.dart';
  ...
  Widget buildRegisterContainer() {
    return  (choosenLanguage != '') ? Align(
      ...
      child: Container(
        ...
        //   },
        //   child: isLogin ? Text(
        //       languages[choosenLanguage]['Don t have an account? Sign up'],
        //     style: const TextStyle(
        //       color: PinkColors,
        //       fontSize: 18
        //     ),
